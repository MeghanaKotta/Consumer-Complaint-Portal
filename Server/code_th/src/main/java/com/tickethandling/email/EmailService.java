package com.tickethandling.email;
...
import com.tickethandling.auth.services.UtilityService;
...
public class EmailService {
	...
	private String currenServertHosting;
	...
	public void sendSimpleMessage(String to, String subject, String text) {
		...
		Thread t1 = new Thread(new Runnable() {
			...
			public void run() {
				...
				message.setFrom("noreply@TicketHandling.com");
				message.setTo(to);
		...
		Thread t1 = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					helper.setTo(to);
					helper.setFrom("noreply@TicketHandling.com");
//					mimeMessage.setContent(htmlMsg, "text/html");
	...
	public void sendActivationEmail(Long userId, String emailId) throws Exception {
		...
		String activationURL = String.format("%s/account/activateEmail?q=%s", currenServertHosting, randomString);
		...
		String htmlStr = String.format("<html><body><a href= %s >Click here to activate your email</a>"
				+ " <br /> Thanks <br /> TicketHandlingManagement" + "</body></html>", activationURL);
...
//		sendSimpleMessage(emailId, subject, text);
	...
	public boolean sendPasswordResetMail(String emailid, String passwordlink) throws Exception {
		try {
			String activationURL = String.format("%s/account/resetPassword?e=%s&q=%s",currentUiHosting, emailid,
					passwordlink);
	...
	public void sendSimpleMessageWithHTMLToManypersons(String[] to, String subject, String emailContent) throws Exception {
